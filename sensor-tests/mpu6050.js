...
module.exports = {
	...
	getAcceleration: function(){
		var oBuffer = this.oWire.readBytes(0x3B, 6, function(oErr){ if(oErr == null) return; console.log(oErr); });
	...
	getRotation: function(){
		var oBuffer = this.oWire.readBytes(0x43, 6, function(oErr){ if(oErr == null) return; console.log(oErr); });
	...
	// read compass data
	getCompass: function(){
		var oBuffer = this.oWire.readBytes(0x03, 7, function(oErr){ if(oErr == null) return; console.log(oErr); });
	...
	get6Axis: function(){
		var oBuffer = this.oWire.readBytes(0x3B, 14, function(oErr){ if(oErr == null) return; console.log(oErr); });
