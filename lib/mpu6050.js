...
module.exports = {
  ...
  getAccelerationZeroG: function(){
    ...
    return [Math.round((oData[0] - this.aAccelerationOffsets[0]) * this.fAcceleration), Math.round((oData[1] - this.aAccelerationOffsets[1]) * this.fAcceleration), Math.round((oData[2] - this.aAccelerationOffsets[2]) * this.fAcceleration)];
  },
