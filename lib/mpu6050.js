...
module.exports = {
	...
	init: function(lVersion){
		...
		/*// set clock to x gyro
		this.oWire.writeBytes(0x6B, 2, 0x01, this.handleError.bind(this));
		// set gyroscope to most sensitive setting
		this.oWire.writeBytes(0x1B, 4, 0x00, this.handleError.bind(this));
		// set accelerometer to most sensitive setting
		this.oWire.writeBytes(0x1C, 4, 0x00, this.handleError.bind(this));*/
	},
