...
module.exports = {
	...
	init: function(lVersion){
		...
		// set clock to x gyro
		this.oWire.writeBytes(0x6B, 2, 0x01, this.handleError);
		// set gyroscope to most sensitive setting
		this.oWire.writeBytes(0x1B, 4, 0x00, this.handleError);
		// set accelerometer to most sensitive setting
		this.oWire.writeBytes(0x1C, 4, 0x00, this.handleError);
	},

	// FUNCTION
	// get raw acceleration data
	getAcceleration: function(){
		var oBuffer = this.oWire.readBytes(0x3B, 6, this.handleError);
	...
	getRotation: function(){
		var oBuffer = this.oWire.readBytes(0x43, 6, this.handleError);
  ...
  getRotationOffset: function(){
    var oBuffer = this.oWire.readBytes(0x13, 6, this.handleError);
    return [oBuffer.readInt16BE(0), oBuffer.readInt16BE(2), oBuffer.readInt16BE(4)];
  },
  ...
  getTemperature: function(){
    var oData = this.oWire.readBytes(0x41, 2, this.handleError);
	...
	// read compass data
	getCompass: function(){
		var oBuffer = this.oWire.readBytes(0x03, 7, this.handleError);
